...
const MOCK_CHILDREN: Record<string, StorefrontChild> = {
  ...
  "2": {
    ...
    gifts: [
      {
        id: "gift-4",
        title: "Art Supply Kit Art Supply KitArt Supply KitArt Supply KitArt Supply KitArt Supply KitArt Supply Kit",
    ...
    <div className="w-full min-h-screen bg-background">
      <div className="w-full px-4 py-8 lg:px-8 lg:py-12">
        <div className="max-w-7xl mx-auto">
          <div
            className="w-full px-3 py-4 sm:py-6 lg:px-12 lg:py-12 rounded-3xl bg-kfk-red"
          >
