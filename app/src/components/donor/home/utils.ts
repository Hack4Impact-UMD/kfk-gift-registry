  ...
  return Object.fromEntries(
    gifts.map((g) => [
      g.id,
      {
        ...
        savedDelivered: ["DELIVERED", "RECEIVED"].includes(g.status),
        receivedByFamily: g.status === "RECEIVED",
        receiptFileName: g.purchaseReceiptFileName,
        receiptPath: g.purchaseReceiptPath,
        savedReceiptFileName: g.purchaseReceiptFileName,
        savedReceiptPath: g.purchaseReceiptPath,
        deliveryReceiptFileName: g.deliveryReceiptFileName,
        deliveryReceiptPath: g.deliveryReceiptPath,
        savedDeliveryReceiptFileName: g.deliveryReceiptFileName,
        savedDeliveryReceiptPath: g.deliveryReceiptPath,
