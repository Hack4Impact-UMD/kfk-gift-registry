...
export function ReauthAlertDialog({
  open,
  onFail,
  onConfirmed,
  authCtx,
}: ReauthAlertDialogProps) {
    ...
    <AlertDialog open={open}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Since this is a sensitive action, you will need to re-enter your
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={onFail} disabled={pending}>
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction
