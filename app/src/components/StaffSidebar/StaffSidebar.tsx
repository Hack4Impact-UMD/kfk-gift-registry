...
const SidebarIcon = ({
  ...
  <div className="relative">
    ...
    <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`transition-text duration-500 ease-in-out ${isPressed ? pressedColor : 'text-gray-500 group-hover/button:text-black'} size-6`}>
      {children}
    </svg>
...
const SidebarMenuButtonWithHovering = ({children}:Props) => {
          ...
          <SidebarMenu className="flex-col gap-2">
                ...
                <Select onOpenChange={setIsDropdownPressed} value={year} onValueChange={setYear}>
                  <SidebarMenuButtonWithTooltip label={year}>
                    ...
                    >
                      ...
                      <SidebarIcon isPressed={isDropdownPressed} pressedColor="text-[var(--color-kfk-blue)]">
                        <path 
                          strokeLinecap="round" 
                ...
                <SidebarMenuButtonWithHovering>
                  {(isPressed) => (
                    <Link to="/staff/home" className="group/button flex items-center gap-2 group-data-[collapsible=icon]:justify-center">
                      <SidebarIcon isPressed={isPressed} pressedColor="text-[var(--color-kfk-red)]">
                        <path 
                          strokeLinecap="round" 
                          strokeLinejoin="round" 
                      ...
                      <span className={`group-data-[collapsible=icon]:hidden transition-text duration-500 ease-in-out ${isPressed ? 'text-[var(--color-kfk-red)]' : ''}`}>Home</span>
                    </Link>
                  )}
                </SidebarMenuButtonWithHovering>
            ...
            <SidebarMenuItem className="flex justify-center">
              <SidebarMenuButtonWithTooltip label="Profile Approval">
                <SidebarMenuButtonWithHovering>
                  {(isPressed) => (
                    <Link to="/staff/home" className="group/button flex items-center gap-2 group-data-[collapsible=icon]:justify-center"> {/* Placeholder Link */}
                      <SidebarIcon isPressed={isPressed} pressedColor="text-[var(--color-kfk-yellow)]">
                        <path 
                          strokeLinecap="round" 
                          strokeLinejoin="round" 
                      ...
                      <span className={`group-data-[collapsible=icon]:hidden transition-text duration-500 ease-in-out ${isPressed ? 'text-[var(--color-kfk-yellow)]' : ''}`}>Profile Approval</span>
                    </Link>
                  )}
                </SidebarMenuButtonWithHovering>
            ...
            <SidebarMenuItem className="flex justify-center">
              <SidebarMenuButtonWithTooltip label="Approved Profiles">
                  <SidebarMenuButtonWithHovering>
                    {(isPressed) => (
                    <Link to="/staff/approved" className="group/button flex items-center gap-2 group-data-[collapsible=icon]:justify-center">
                      <SidebarIcon isPressed={isPressed} pressedColor="text-[var(--color-kfk-blue)]">
                        <path 
                          strokeLinecap="round" 
                          strokeLinejoin="round" 
                      ...
                      <span className={`group-data-[collapsible=icon]:hidden transition-text duration-500 ease-in-out ${isPressed ? 'text-[var(--color-kfk-blue)]' : ''}`}>Approved Profiles</span>
                    </Link>
                    )}
                  </SidebarMenuButtonWithHovering>
            ...
            <SidebarMenuItem className="flex justify-center">
              <SidebarMenuButtonWithTooltip label="User Management">
                <SidebarMenuButtonWithHovering>
                  {(isPressed) => (
                    <Link to="/staff/home" className="group/button flex items-center gap-2 group-data-[collapsible=icon]:justify-center"> {/* Placeholder Link */}
                      <SidebarIcon isPressed={isPressed} pressedColor="text-[var(--color-kfk-green)]">
                        <path 
                          strokeLinecap="round" 
                          strokeLinejoin="round" 
                      ...
                      <span className={`group-data-[collapsible=icon]:hidden transition-text duration-500 ease-in-out ${isPressed ? 'text-[var(--color-kfk-green)]' : ''}`}>User Management</span>
                    </Link>
                  )}
                </SidebarMenuButtonWithHovering>
